...
function GoogleIcon() {
    return (
        <svg viewBox="0 0 48 48" className="h-5 w-5">
          ...
          <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.902,35.636,44,30.138,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
        </svg>
    )
}
...
export default function LoginPage() {
    ...
    const handleEmailLogin = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        // The login server action handles all redirects.
        // There's no need to handle success/error here on the client.
        // The page will either redirect or reload with an error message.
        await login(formData);
        // Setting loading to false here is a fallback in case the redirect fails for some reason
        // client-side, preventing the button from being stuck forever.
        setIsLoading(false);
    }
