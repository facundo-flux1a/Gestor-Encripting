...
import { TutorialProvider } from '@/context/tutorial-context'; // ← NUEVO
...
export default async function RootLayout({
  ...
  return (
    <html lang="es" suppressHydrationWarning>
      ...
      <body className="font-body antialiased bg-background min-h-screen w-full overflow-x-hidden">
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
          enableSystem
