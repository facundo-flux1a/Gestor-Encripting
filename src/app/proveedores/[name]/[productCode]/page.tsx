...
export default async function ProductDetailPage({
    ...
    const { productInfo, history } = productData;
            ...
            <div className="flex-1 space-y-6 p-4 pt-6 md:p-8">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground mt-1">
                                Basado en {history.length} compras
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground mt-1">
                                {productInfo.numero_documento || 'Sin número'}
                            </p>
                        </CardContent>
                    </Card>
                </div>
                ...
                {history.length > 1 && (
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Historial de precios en las últimas {history.length} compras
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ProductPriceChart history={history} />
                        </CardContent>
                    </Card>
                )}
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Todas las compras registradas de este producto
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Table>
                                ...
                                {history.map((item, index) => {
                                    ...
                                    return (
                                        <TableRow key={`${item.documento_id}-${index}`}>
                                            ...
                                            <TableCell className="text-right">
                                                {formatCurrency(item.importe_linea)}
                                            </TableCell>
