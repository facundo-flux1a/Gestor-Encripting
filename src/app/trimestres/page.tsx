...
function TrimestresPageContent() {
  ...
  const mapToStatsBreakdown = (summary: any) => {
    ...
    const totalDescuento = summary.descuentos?.total || 0;
    const totalDocumentoReal = summary.totalReal?.total || (totalBaseTeorica + totalIvaTeorico + totalRecargo - totalRetencion - totalDescuento);
