            ...
            steps: [
                ...
                ...(hasRows ? [{
                    ...
                    popover: {
                        ...
                        description: 'Cada fila tiene acciones: marcar leído, reintentar (si falló) y eliminar el registro de actividad.',
                ...
                }] : []),
                {
                    ...
                    popover: {
                        ...
                        description: 'Ya podés gestionar todo tu historial de documentos.',
